...
public class RoleAction extends BaseAction implements ModelDriven<Role> {
	...
	public void add() {
		...
		this.writeJson(this.renderSuccess("角色添加成功"));
	}
	...
	public void delete() {
		...
		if (ids != null) {
			try {
				...
				this.writeJson(this.renderSuccess("角色删除成功"));
			} catch (Exception e) {
				this.writeJson(this.renderError(e.getMessage()));
				e.printStackTrace();
			}
	...
	public void grant() {
		try {
			...
			this.writeJson(this.renderSuccess("授权成功"));
		} catch (Exception e) {
			this.writeJson(this.renderError("授权失败"));
			e.printStackTrace();
		}
	}
	...
	public void changeStatus() {
		try {
			...
			this.writeJson(this.renderSuccess("更改角色成功"));
		} catch (Exception e) {
			this.writeJson(this.renderError("更改角色失败"));
			e.printStackTrace();
		}
	...
	public void findPermitIdListByRoleId() {
		...
		this.writeJson(this.renderSuccess(permitIds));
	}
